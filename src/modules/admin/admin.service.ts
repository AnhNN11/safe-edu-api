...
import { AdminRepositoryInterface } from './interfaces/admin.interface';
  ...
  export class AdminService {
    ...
    async setCurrentRefreshToken(adminId: string, refreshToken: string): Promise<void> {
        try {
    ...
    async findOneByCondition(condition: FilterQuery<Admin>): Promise<Admin | null> {
    ...
    async update(
      ...
      const updatedAdmin = await this.adminRepository.update(id,{...updateUserDto});
      if (!updatedAdmin) {
